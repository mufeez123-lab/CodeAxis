...
const Projects = () => {
  const projects = [
    ...
    },
    {
      ...
      description:
        "HIPAA-compliant patient management system with appointment scheduling and medical records.",
      image:
    ...
    },
    {
      ...
      description:
        "Affordable and responsive websites tailored for small businesses, including blogs, portfolios, and service showcases.",
      image:
    ...
    },
    {
      ...
      description:
        "Property listing platform with advanced search, virtual tours, and CRM integration.",
      image:
    ...
    },
    {
      ...
      description:
        "Cloud-based inventory tracking system with barcode scanning and automated reordering.",
      image:
    ...
    },
    {
      ...
      description:
        "Online education platform with video streaming, progress tracking, and certification system.",
      image:
            ...
            >
              ...
              <div className="p-6 space-y-4">
                ...
                <div className="flex space-x-4 pt-4 border-t border-gray-100">
                  {/* Uncomment if you want live demo / GitHub buttons */}
