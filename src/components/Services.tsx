  ...
  const services = [
    {
      ...
      description: "Bespoke software solutions tailored to your business processes and requirements.",
      features: ["Enterprise Applications", "API Development", "System Integration", "Legacy Modernization"]
    },
    {
      icon: <Globe className="h-8 w-8" />,
      title: "Web Development",
      description: "Modern, responsive websites and web applications that engage your audience.",
      features: ["React/Next.js Apps", "E-commerce Platforms", "CMS Development", "Progressive Web Apps"]
    },
    {
    ...
    },
    {
      ...
      features: ["Database Design", "Performance Optimization", "Data Migration", "Analytics Setup"]
    },
    {
      icon: <Cloud className="h-8 w-8" />,
      title: "Cloud Services",
      description: "Cloud infrastructure setup, migration, and optimization for scalability.",
      features: ["AWS/Azure/GCP", "DevOps & CI/CD", "Infrastructure as Code", "Cloud Migration"]
    },
    {
      icon: <Cog className="h-8 w-8" />,
      title: "Technical Consulting",
      description: "Strategic technology guidance to help you make informed decisions.",
      features: ["Architecture Review", "Technology Strategy", "Code Audits", "Team Training"]
    }
  ];
